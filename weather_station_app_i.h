...
struct WeatherStationApp {
    ...
    /* Hidden, session-only AUTO LAB. Sensor profiles live on SD; RAM keeps
       only ten compact fingerprints plus one reusable decode/TX state. */
    bool lab_unlocked;
