...
void weather_station_scene_about_on_enter(void* context) {
    ...
    furi_string_printf(temp_str, "\e#Informacje\n");
    furi_string_cat_printf(temp_str, "Wersja: %s\n", FAP_VERSION);
    furi_string_cat_printf(temp_str, "Autor: %s\n\n", WS_DEVELOPED);


    furi_string_cat_printf(temp_str, "\e#Prot. RX\n");
    ...
    /* Empty soft-button: seven short OK presses open the hidden PIN screen. */
